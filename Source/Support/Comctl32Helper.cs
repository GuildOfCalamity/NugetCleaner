...
namespace NugetCleaner.Support
{
    ...
    public static class Comctl32Helper
    {
        [DllImport("comctl32.dll", EntryPoint = "SetWindowSubclass", SetLastError = false)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool SetWindowSubclass(IntPtr hWnd, IntPtr pfnSubclass, uint uIdSubclass, IntPtr dwRefData);

        [DllImport("comctl32.dll", EntryPoint = "DefSubclassProc", SetLastError = false)]
        internal static extern IntPtr DefSubclassProc(IntPtr hWnd, WindowMessage uMsg, IntPtr wParam, IntPtr lParam);
    }

    /// <summary>
    /// Contains information about the window's maximum size and position, and its minimum and maximum tracking sizes.
    /// </summary>
    ...
    /// <summary>
    /// Contains data to be passed to another application through the WM_COPYDATA message.
    /// </summary>
